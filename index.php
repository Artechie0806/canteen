...
<ul class="nav_links">
    <li><a class="login"><button id="login"  data-bs-toggle="modal" data-bs-target="#exampleModal">Login</button></a>
        <!-- Modal -->
        <div class="modal fade" data-bs-focus="false" id="exampleModal" data-focus="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content" style="background-color: rgba(240, 248, 255, 0);">
              ...
              <div class="modal-body bg-dark" style="text-align: center;">
               ...
               <label for="email_id" style="background-color:rgba(240, 248, 255, 0);padding-bottom:5px;">E-mail</label><br>
               <input type="email" placeholder="abc@gmail.com" name="email_id" required><br>
               <label for="u_pass" style="background-color:rgba(240, 248, 255, 0);padding-top:5px;padding-bottom:5px;">Password</label><br>
    ...
    <li><a class="register" href="#"><button id="register"data-bs-toggle="modal" data-bs-target="#exampleModal2">Register</button></a>
      <div class="modal fade" data-bs-focus="false" id="exampleModal2" data-focus="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content" style="background-color: rgba(240, 248, 255, 0);">
            <div class="modal-header bg-dark" style="border-color: rgba(255, 237, 191, 0.714);">
            ...
            <label for="email_id" style="background-color:none;padding-top:10px;padding-bottom:10px;">E-mail</label><br>
            <input type="email" placeholder="abc@gmail.com" name="u_email"  required><br>
            <label for="u_pass" style="background-color:none;padding-top:5px;padding-bottom:10px;">Password</label><br>
            <input type="password"placeholder="Password" name="u_pass" required><br>
            <label for="u_pass1" style="background-color:none;padding-top:10px;padding-bottom:10px;">Re-enter Password</label><br>
...
<div class="sec">
  ...
  <p class="hidden"><img class="feat_img" src="media\hotfood.jpg" alt=".."></p></section>
  <section>
  ...
  <section1>
   <div class="hidden" style="padding: 1% 3%; background-color: black;border-radius: 10px;"><img src="media/para-img.jpg" style="height:19vh; float: left; padding: 10px;" ALIGN=”left” HSPACE=”10” VSPACE=”10”/>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iusto accusantium sint cupiditate magnam, corrupti quibusdam ipsa est quasi debitis ipsum et, nesciunt adipisci! Beatae iusto natus maiores animi labore dolore. Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor recusandae saepe dignissimos inventore, architecto tempore. Obcaecati a ducimus cum at ad nulla molestiae perferendis non laborum? Soluta omnis adipisci consequuntur!</div>
  </section1>
  <section1>
    <div class="hidden" style="padding: 1% 3%; background-color: black;border-radius: 10px;"><img src="media/para-img.jpg" style="height:19vh; float: right; padding: 10px;" ALIGN=”left” HSPACE=”10” VSPACE=”10”/>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Iusto accusantium sint cupiditate magnam, corrupti quibusdam ipsa est quasi debitis ipsum et, nesciunt adipisci! Beatae iusto natus maiores animi labore dolore. Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor recusandae saepe dignissimos inventore, architecto tempore. Obcaecati a ducimus cum at ad nulla molestiae perferendis non laborum? Soluta omnis adipisci consequuntur!</div>
  </section1>
</div>
<section>
